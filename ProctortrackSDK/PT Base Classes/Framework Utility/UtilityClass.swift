...
//let maxSizeOfVedio = 5242880 //Bytes or % 5 MB
let maxSizeOfVedio = 1000000 //Bytes or % 1 MB

class UtilityClass
{
 
    //Method for calculating the maximum memory Allocation
    class func calculateMemoryAllocation(_ testTimeDuration: Int) -> Int64
    {
        
        let numberOfChunk = testTimeDuration/maxTimeOfVedio
        
        let memoryCapacityRequired = maxSizeOfVedio * numberOfChunk
        
        return Int64(memoryCapacityRequired)
    }
 ...
 //Find the datatype of the variable function
    ...
    //change the orienation of image
    //Fix Orientation
